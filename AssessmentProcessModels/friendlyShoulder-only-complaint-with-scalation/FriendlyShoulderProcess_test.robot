...
TC_BlindBatch
    ...
    Create File    C:/Users/tales/LocalDocuments/Development/aat4pais/AssessmentProcessModels/friendlyShoulder-only-complaint-with-scalation/executedKeywords-friendlyShoulder-only-complaint-with-scalation.json    ${json_string} 
    ${data}=    Evaluate    json.loads(open("C:/Users/tales/LocalDocuments/Development/aat4pais/AssessmentProcessModels/friendlyShoulder-only-complaint-with-scalation/executedKeywords-friendlyShoulder-only-complaint-with-scalation.json").read()) 
    ...
    Create File    C:/Users/tales/LocalDocuments/Development/aat4pais/AssessmentProcessModels/friendlyShoulder-only-complaint-with-scalation/executionsCounter-friendlyShoulder-only-complaint-with-scalation.txt    ${output} 
