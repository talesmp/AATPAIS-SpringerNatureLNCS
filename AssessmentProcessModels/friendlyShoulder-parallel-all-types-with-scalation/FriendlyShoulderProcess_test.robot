...
TC_BlindBatch
    ...
    Create File    C:/Users/tales/LocalDocuments/Development/aat4pais/AssessmentProcessModels/friendlyShoulder-parallel-all-types-with-scalation/executedKeywords-friendlyShoulder-parallel-all-types-with-scalation.json    ${json_string} 
    ${data}=    Evaluate    json.loads(open("C:/Users/tales/LocalDocuments/Development/aat4pais/AssessmentProcessModels/friendlyShoulder-parallel-all-types-with-scalation/executedKeywords-friendlyShoulder-parallel-all-types-with-scalation.json").read()) 
    ...
    Create File    C:/Users/tales/LocalDocuments/Development/aat4pais/AssessmentProcessModels/friendlyShoulder-parallel-all-types-with-scalation/executionsCounter-friendlyShoulder-parallel-all-types-with-scalation.txt    ${output} 
