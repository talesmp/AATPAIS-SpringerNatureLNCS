...
TC_BlindBatch
    ...
    Create File    C:/Users/tales/LocalDocuments/Development/aat4pais/AssessmentProcessModels/friendlyShoulder-only-suggestion-compliment/executedKeywords-friendlyShoulder-only-suggestion-compliment.json    ${json_string} 
    ${data}=    Evaluate    json.loads(open("C:/Users/tales/LocalDocuments/Development/aat4pais/AssessmentProcessModels/friendlyShoulder-only-suggestion-compliment/executedKeywords-friendlyShoulder-only-suggestion-compliment.json").read()) 
    ...
    Create File    C:/Users/tales/LocalDocuments/Development/aat4pais/AssessmentProcessModels/friendlyShoulder-only-suggestion-compliment/executionsCounter-friendlyShoulder-only-suggestion-compliment.txt    ${output} 
