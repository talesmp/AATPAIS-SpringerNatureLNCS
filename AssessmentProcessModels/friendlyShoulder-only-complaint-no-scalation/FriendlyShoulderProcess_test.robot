...
TC_BlindBatch
    ...
    Create File    C:/Users/tales/LocalDocuments/Development/aat4pais/AssessmentProcessModels/friendlyShoulder-only-complaint-no-scalation/executedKeywords-friendlyShoulder-only-complaint-no-scalation.json    ${json_string} 
    ${data}=    Evaluate    json.loads(open("C:/Users/tales/LocalDocuments/Development/aat4pais/AssessmentProcessModels/friendlyShoulder-only-complaint-no-scalation/executedKeywords-friendlyShoulder-only-complaint-no-scalation.json").read()) 
    ...
    Create File    C:/Users/tales/LocalDocuments/Development/aat4pais/AssessmentProcessModels/friendlyShoulder-only-complaint-no-scalation/executionsCounter-friendlyShoulder-only-complaint-no-scalation.txt    ${output} 
