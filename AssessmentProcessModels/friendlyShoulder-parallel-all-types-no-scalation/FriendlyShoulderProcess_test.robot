...
TC_BlindBatch
    ...
    Create File    C:/Users/tales/LocalDocuments/Development/aat4pais/AssessmentProcessModels/friendlyShoulder-parallel-all-types-no-scalation/executedKeywords-friendlyShoulder-parallel-all-types-no-scalation.json    ${json_string} 
    ${data}=    Evaluate    json.loads(open("C:/Users/tales/LocalDocuments/Development/aat4pais/AssessmentProcessModels/friendlyShoulder-parallel-all-types-no-scalation/executedKeywords-friendlyShoulder-parallel-all-types-no-scalation.json").read()) 
    ...
    Create File    C:/Users/tales/LocalDocuments/Development/aat4pais/AssessmentProcessModels/friendlyShoulder-parallel-all-types-no-scalation/executionsCounter-friendlyShoulder-parallel-all-types-no-scalation.txt    ${output} 
